...
| sysroot-glibc-linaro-2.21-2017.05-aarch64-linux-gnu.tar.xz | /cross            | /sysroot-aarch64 |
...
export CFLAGS="-I${MY_PREFIX}/include $CFLAGS"
export LDFLAGS="-L${MY_PREFIX}/lib -Wl,-rpath=${MY_PREFIX}/lib -Wl,-rpath=${MY_PREFIX}/lib64 $LDFLAGS"
...
vim /etc/profile
# webengine
export PKG_CONFIG_PATH=/sysroot-aarch64/aarch64/lib/pkgconfig:/sysroot-aarch64/aarch64/share/pkgconfig
export CPLUS_INCLUDE_PATH=/sysroot-aarch64/aarch64/include:$CPLUS_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=/sysroot-aarch64/aarch64/include/nss:$CPLUS_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=/sysroot-aarch64/aarch64/include/nspr:$CPLUS_INCLUDE_PATH
export LD_LIBRARY_PATH=/sysroot-aarch64/aarch64/lib:$LD_LIBRARY_PATH
source /etc/profile
```
...
![](/media/image/2024-04-30-qt5.15.2交叉编译/configure.png)
...
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:227:30: warning: missing braces around initializer [-Wmissing-braces]
       int16x4x4_t quadrant = { dcval, dcval, dcval, dcval };
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:227:30: note: (near initialization for ‘quadrant’)
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:269:20: error: incompatible types when assigning to type ‘int64_t {aka long int}’ from type ‘int64x1_t’
   bitmap_rows_4567 = vreinterpret_s64_s16(bitmap);
                    ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:273:29: error: incompatible types when initializing type ‘int64_t {aka long int}’ using type ‘int64x1_t’
   int64_t right_ac_bitmap = vreinterpret_s64_s16(bitmap);
                             ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:280:24: error: incompatible types when assigning to type ‘int64_t {aka long int}’ from type ‘int64x1_t’
     right_ac_dc_bitmap = vreinterpret_s64_s16(bitmap);
                        ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:284:30: warning: missing braces around initializer [-Wmissing-braces]
       int16x4x4_t quadrant = { dcval, dcval, dcval, dcval };
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:284:30: note: (near initialization for ‘quadrant’)
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c: In function ‘jsimd_idct_islow_pass1_regular’:
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:350:30: warning: implicit declaration of function ‘vld1_s16_x3’ [-Wimplicit-function-declaration]
   const int16x4x3_t consts = vld1_s16_x3(jsimd_idct_islow_neon_consts);
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:350:30: error: invalid initializer
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c: In function ‘jsimd_idct_islow_pass1_sparse’:
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:473:30: error: invalid initializer
   const int16x4x3_t consts = vld1_s16_x3(jsimd_idct_islow_neon_consts);
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c: In function ‘jsimd_idct_islow_pass2_regular’:
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:553:30: error: invalid initializer
   const int16x4x3_t consts = vld1_s16_x3(jsimd_idct_islow_neon_consts);
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:660:35: warning: missing braces around initializer [-Wmissing-braces]
   uint16x4x4_t cols_01_23_45_67 = { vreinterpret_u16_u8(cols_01_23.val[0]),
                                   ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:660:35: note: (near initialization for ‘cols_01_23_45_67’)
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c: In function ‘jsimd_idct_islow_pass2_sparse’:
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:693:30: error: invalid initializer
   const int16x4x3_t consts = vld1_s16_x3(jsimd_idct_islow_neon_consts);
                              ^
../../../../../qtwebengine/src/3rdparty/chromium/third_party/libjpeg_turbo/simd/arm/common/jidctint-neon.c:758:35: warning: missing braces around initializer [-Wmissing-braces]
   uint16x4x4_t cols_01_23_45_67 = { vreinterpret_u16_u8(cols_01_23.val[0]),
                                   ^
```
...
```
../../../../../qtwebengine/src/3rdparty/chromium/v8/../../../../../qtwebengine/src/3rdparty/chromium/v8/src/deoptimizer/deoptimizer.cc: In static member function ‘static void v8::internal::Deoptimizer::EnsureCodeForDeoptimizationEntry(v8::internal::Isolate*, v8::internal::DeoptimizeKind)’:
../../../../../qtwebengine/src/3rdparty/chromium/v8/../../../../../qtwebengine/src/3rdparty/chromium/v8/src/deoptimizer/deoptimizer.cc:1822:50: error: use of deleted function ‘v8::internal::MacroAssembler::MacroAssembler(v8::internal::Isolate*, v8::internal::CodeObjectRequired, std::unique_ptr<v8::internal::AssemblerBuffer>)’
                       NewAssemblerBuffer(16 * KB));
                                                  ^
In file included from ../../../../../qtwebengine/src/3rdparty/chromium/v8/src/codegen/macro-assembler.h:39:0,
                 from ../../../../../qtwebengine/src/3rdparty/chromium/v8/../../../../../qtwebengine/src/3rdparty/chromium/v8/src/deoptimizer/deoptimizer.cc:13,
                 from gen/v8/v8_base_without_compiler_jumbo_13.cc:6:
../../../../../qtwebengine/src/3rdparty/chromium/v8/src/codegen/arm64/macro-assembler-arm64.h:1423:25: note: ‘v8::internal::MacroAssembler::MacroAssembler(v8::internal::Isolate*, v8::internal::CodeObjectRequired, std::unique_ptr<v8::internal::AssemblerBuffer>)’ is implicitly deleted because the default definition would be ill-formed:
...
经过上述步骤就能获得 `arm64` 版本的 `qt5.15.2`，接下来是验证是否可以将程序编译成 `arm` 版本，主要验证 `webengine` 模块功能。

下载安装 `qt-opensource-linux-x64-5.14.2.run` 最后一个离线安装版本。
...
![](/media/image/2024-04-30-qt5.15.2交叉编译/add_qmake.png)

然后在构建套件中添加一个交叉编译 `arm` 版本，参数如下：

![](/media/image/2024-04-30-qt5.15.2交叉编译/add_kits.png)

使用 `simplebrowser.pro` 示例进行测试。可以看到最终编译结果是 `arm` 版本。

![](/media/image/2024-04-30-qt5.15.2交叉编译/build_result.png)
...
# webengine
export PKG_CONFIG_PATH=/sysroot-aarch64/aarch64/lib/pkgconfig:/sysroot-aarch64/aarch64/share/pkgconfig
export CPLUS_INCLUDE_PATH=$CPLUS_INCLUDE_PATH:/sysroot-aarch64/aarch64/include
export CPLUS_INCLUDE_PATH=$CPLUS_INCLUDE_PATH:/sysroot-aarch64/aarch64/include/nss
export CPLUS_INCLUDE_PATH=$CPLUS_INCLUDE_PATH:/sysroot-aarch64/aarch64/include/nspr
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/sysroot-aarch64/aarch64/lib
