...
![image-20220804221032451](/media/image/2022-08-04-Git/git查看版本.png)
...
![image-20220804221533262](/media/image/2022-08-04-Git/git全局配置.png)
...
![image-20220804222826847](/media/image/2022-08-04-Git/github配置.png)

新建一个连接，`Title` 表示名称随便取，`Key` 则是将 `id_rsa.pub` 文件中的内容拷贝进去。

![image-20220804223051242](/media/image/2022-08-04-Git/github配置-add.png)
