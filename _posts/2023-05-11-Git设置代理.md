...
| 参数   | 说明                                                                                            |
| :----- | :---------------------------------------------------------------------------------------------- |
| `-X 5` | `-X 5` 指代理协议 `Socks 5`， `-X 4` 指代理协议 `Socks 4`， `-X connect`指代理协议 `Socks HTTP` |

### 测试代理生效

打开 `Git Bash` 终端界面。输入 `ssh -T git@github.com`。

以下返回则代理成功。

![image-20230512000142027](/media/image/2023-05-11-Git设置代理/ssh_test.png)
